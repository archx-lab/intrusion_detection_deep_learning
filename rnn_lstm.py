...
csv_logger = CSVLogger('results/training_set_iranalysis3.csv',separator=',', append=False)
print(model.summary())
model.fit(X_train, y_train, batch_size=batch_size, epochs=100, validation_data=(X_test, y_test),callbacks=[checkpointer,csv_logger])
model.save("results/lstm4layer_model.hdf5")
